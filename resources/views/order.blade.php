...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/order.css') }}">
...
<span style="font-size: 24px;color: red;letter-spacing: -2px;">{{session('error')}}</span>
...
<script type="text/javascript" src="{{ secure_asset('js/order.js') }}"></script>
